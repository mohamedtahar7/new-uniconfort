...
const Page = () => {
  ...
  // Filter cleanly for the Salons category
  const salonProducts =
      ...
      <div className="max-w-[1400px] mx-auto">
        ...
        <div className="border-b border-slate-100 pb-8 mb-12 space-y-2">
          ...
          <h1 className="text-4xl md:text-5xl font-light tracking-tight text-[#0D2B45]">
            Espaces{" "}
            <span className="font-serif italic text-slate-400">Salons</span>
          </h1>
          <p className="text-slate-400 text-sm font-light max-w-md pt-1">
            Des ensembles d'assises et configurations de caractère pensés pour
            redéfinir la convivialité, alliant confort d'exception et rigueur
            esthétique.
          </p>
        </div>
