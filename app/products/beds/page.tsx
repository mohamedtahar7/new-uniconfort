...
const Page = () => {
  ...
  // Filter cleanly for the Lits category
  const bedProducts =
      ...
      <div className="max-w-[1400px] mx-auto">
        ...
        <div className="border-b border-slate-100 pb-8 mb-12 space-y-2">
          ...
          <h1 className="text-4xl md:text-5xl font-light tracking-tight text-[#0D2B45]">
            Espaces{" "}
            <span className="font-serif italic text-slate-400">Lits</span>
          </h1>
          <p className="text-slate-400 text-sm font-light max-w-md pt-1">
            Une invitation à la sérénité. Découvrez des structures de lits
            d'exception alliant design épuré, matériaux nobles et finitions
            artisanales rigoureuses.
          </p>
        </div>
